...
#line 143 "bison.tab.c" /* yacc.c:355  */
};
...
#line 160 "bison.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "INTEIRO", "REAL", "ID", "PRINT", "MAIS",
  "MENOS", "VEZES", "DIVIDE", "POTENCIA", "VIRGULA", "IGUAL", "E_PAR",
  "D_PAR", "N_LINHA", "PONTO_VIRGULA", "$accept", "entrada", "line",
  "iexp", YY_NULLPTR
};
#endif
...
{
     -13,     0,   -13,   -12,    -1,   -13,   -10,    -1,   -13,   -13,
     -13,    -1,    24,    -7,    24,    15,    -1,    -1,    -1,    -1,
      -1,   -13,   -13,    18,    18,     3,     3,    24
};
...
{
       2,     0,     1,     0,     0,     4,     0,     0,    12,    13,
      14,     0,     6,     0,     5,     0,     0,     0,     0,     0,
       0,     3,    15,    10,    11,     8,     9,     7
};
...
{
       2,     7,     8,     9,    10,     3,     4,    13,    14,    21,
       0,     0,    15,    11,    20,     0,     5,    23,    24,    25,
      26,    27,    16,    17,    18,    19,    20,    18,    19,    20,
      22,    16,    17,    18,    19,    20
};

static const yytype_int8 yycheck[] =
{
       0,    13,     3,     4,     5,     5,     6,    17,     7,    16,
      -1,    -1,    11,    14,    11,    -1,    16,    16,    17,    18,
      19,    20,     7,     8,     9,    10,    11,     9,    10,    11,
      15,     7,     8,     9,    10,    11
};
...
{
       0,    19,     0,     5,     6,    16,    20,    13,     3,     4,
       5,    14,    21,    17,    21,    21,     7,     8,     9,    10,
      11,    16,    15,    21,    21,    21,    21,    21
};
...
#line 48 "bison.y" /* yacc.c:1646  */
    {(yyval.a) = newasgn((yyvsp[-2].s), (yyvsp[0].a), 1); }
#line 1261 "bison.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 49 "bison.y" /* yacc.c:1646  */
    {(yyval.a) = newcall((yyvsp[-1].a), (yyvsp[0].a)); }
